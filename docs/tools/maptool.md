...
Visit the [Download](/tools/download/) page for version information.

<img src="/assets/img/Bandit1.webp">
</section>
...
- Tremendous macro facility that allows you to automate just about any facet of your game. These are entirely optional bits of code you write yourself or borrow from others you meet in the [forums] or on [Discord].
...
- Head over to the [download page](/tools/download-rptools-products) and follow the steps for your operating system.
- Download a framework from our [framework page] (optional).
- Watch some [tutorials] (optional, but recommended!).
